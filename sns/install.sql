...
DROP TABLE IF EXISTS `sns_action`;
CREATE TABLE IF NOT EXISTS `sns_action` (
...
INSERT INTO `sns_action` (`id`, `name`, `title`, `remark`, `rule`, `log`, `type`, `status`, `update_time`, `module`) VALUES
...
DROP TABLE IF EXISTS `sns_action_limit`;
CREATE TABLE IF NOT EXISTS `sns_action_limit` (
...
INSERT INTO `sns_action_limit` (`id`, `title`, `name`, `frequency`, `time_number`, `time_unit`, `punish`, `if_message`, `message_content`, `action_list`, `status`, `create_time`, `module`) VALUES
...
DROP TABLE IF EXISTS `sns_action_log`;
CREATE TABLE IF NOT EXISTS `sns_action_log` (
...
DROP TABLE IF EXISTS `sns_addons`;
CREATE TABLE IF NOT EXISTS `sns_addons` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `sns_addons` (`id`, `name`, `title`, `description`, `status`, `config`, `author`, `version`, `create_time`, `has_adminlist`) VALUES
...
DROP TABLE IF EXISTS `sns_attachment`;
CREATE TABLE IF NOT EXISTS `sns_attachment` (
...
DROP TABLE IF EXISTS `sns_auth_extend`;
CREATE TABLE IF NOT EXISTS `sns_auth_extend` (
...
INSERT INTO `sns_auth_extend` (`group_id`, `extend_id`, `type`) VALUES
(1, 1, 1),
(1, 1, 2),
(1, 2, 1),
(1, 2, 2),
...
DROP TABLE IF EXISTS `sns_auth_group`;
CREATE TABLE IF NOT EXISTS `sns_auth_group` (
...
INSERT INTO `sns_auth_group` (`id`, `module`, `type`, `title`, `description`, `status`, `rules`) VALUES
(1, 'admin', 1, '普通用户', '', 1, ',338,340,341,344'),
(2, 'admin', 1, 'VIP', '', 1, ',338,340,341,344');

DROP TABLE IF EXISTS `sns_auth_group_access`;
CREATE TABLE IF NOT EXISTS `sns_auth_group_access` (
...
INSERT INTO `sns_auth_group_access` (`uid`, `group_id`) VALUES
(1, 1);

DROP TABLE IF EXISTS `sns_auth_rule`;
CREATE TABLE IF NOT EXISTS `sns_auth_rule` (
...
INSERT INTO `sns_auth_rule` (`id`, `module`, `type`, `name`, `title`, `status`, `condition`) VALUES
...
DROP TABLE IF EXISTS `sns_avatar`;
CREATE TABLE IF NOT EXISTS `sns_avatar` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sns_channel`;
CREATE TABLE IF NOT EXISTS `sns_channel` (
...
INSERT INTO `sns_channel` (`id`, `pid`, `title`, `url`, `sort`, `create_time`, `update_time`, `status`, `target`, `color`, `band_color`, `band_text`, `icon`) VALUES
...
DROP TABLE IF EXISTS `sns_user_nav`;
CREATE TABLE `sns_user_nav` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '频道ID',
  `title` char(30) NOT NULL COMMENT '频道标题',
  `url` char(100) NOT NULL COMMENT '频道连接',
  `sort` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '导航排序',
...
INSERT INTO `sns_user_nav` VALUES ('1', '个人主页', 'ucenter/Index/index', '0', '0', '0', '1', '0', '', '', '', '');
INSERT INTO `sns_user_nav` VALUES ('2', '消息中心', 'ucenter/message/message', '0', '0', '0', '1', '0', '', '', '', '');
INSERT INTO `sns_user_nav` VALUES ('3', '我的收藏', 'ucenter/Collection/index', '0', '0', '0', '1', '0', '', '', '', '');
INSERT INTO `sns_user_nav` VALUES ('4', '我的头衔', 'ucenter/Index/rank', '0', '0', '0', '1', '0', '', '', '', '');

DROP TABLE IF EXISTS `sns_checkin`;
CREATE TABLE IF NOT EXISTS `sns_checkin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `create_time` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `sns_config` (`id`, `name`, `type`, `title`, `group`, `extra`, `remark`, `create_time`, `update_time`, `status`, `value`, `sort`) VALUES
...
CREATE TABLE IF NOT EXISTS `sns_district` (
...
INSERT INTO `sns_district` (`id`, `name`, `level`, `upid`) VALUES
(110000, '北京市', 1, 0),
(120000, '天津市', 1, 0),
(130000, '河北省', 1, 0),
(140000, '山西省', 1, 0),
...
DROP TABLE IF EXISTS `sns_field`;
CREATE TABLE IF NOT EXISTS `sns_field` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `sns_field_group`;
CREATE TABLE IF NOT EXISTS `sns_field_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `sns_field_group` (`id`, `profile_name`, `status`, `createTime`, `sort`, `visiable`) VALUES
(1, '个人资料', 1, 1403847366, 0, 1),
(2, '开发者资料', 1, 1423537648, 0, 0),
(3, '开源中国资料', 1, 1423538446, 0, 0);

DROP TABLE IF EXISTS `sns_field_setting`;
CREATE TABLE IF NOT EXISTS `sns_field_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `sns_field_setting` (`id`, `field_name`, `profile_group_id`, `visiable`, `required`, `sort`, `form_type`, `form_default_value`, `validation`, `status`, `createTime`, `child_form_type`, `input_tips`) VALUES
...
DROP TABLE IF EXISTS `sns_file`;
CREATE TABLE IF NOT EXISTS `sns_file` (
...
DROP TABLE IF EXISTS `sns_hooks`;
CREATE TABLE IF NOT EXISTS `sns_hooks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `sns_hooks` (`id`, `name`, `description`, `type`, `update_time`, `addons`) VALUES
...
DROP TABLE IF EXISTS `sns_invite`;
CREATE TABLE IF NOT EXISTS `sns_invite` (
...
DROP TABLE IF EXISTS `sns_invite_buy_log`;
CREATE TABLE IF NOT EXISTS `sns_invite_buy_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PRIMARY_KEY',
  `invite_type` int(11) NOT NULL COMMENT '邀请类型id',
  `uid` int(11) NOT NULL COMMENT '用户id',
...
DROP TABLE IF EXISTS `sns_invite_log`;
CREATE TABLE IF NOT EXISTS `sns_invite_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PRIMARY_KEY',
  `uid` int(11) NOT NULL COMMENT '用户id',
...
DROP TABLE IF EXISTS `sns_invite_type`;
CREATE TABLE IF NOT EXISTS `sns_invite_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PRIMARY_KEY',
...
DROP TABLE IF EXISTS `sns_invite_user_info`;
CREATE TABLE IF NOT EXISTS `sns_invite_user_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PRIMARY_KEY',
  `invite_type` int(11) NOT NULL COMMENT '邀请类型id',
  `uid` int(11) NOT NULL COMMENT '用户id',
...
DROP TABLE IF EXISTS `sns_local_comment`;
CREATE TABLE IF NOT EXISTS `sns_local_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `app` text NOT NULL,
  `mod` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sns_member` (
...
DROP TABLE IF EXISTS `sns_menu`;
CREATE TABLE IF NOT EXISTS `sns_menu` (
...
INSERT INTO `sns_menu` (`id`, `title`, `pid`, `sort`, `url`, `hide`, `tip`, `group`, `is_dev`, `icon`, `module`) VALUES
...
DROP TABLE IF EXISTS `sns_message_content`;
CREATE TABLE IF NOT EXISTS `sns_message_content` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sns_module` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `sns_module` (`id`, `name`, `alias`, `version`, `is_com`, `show_nav`, `summary`, `developer`, `website`, `entry`, `is_setup`, `sort`, `icon`, `can_uninstall`, `admin_entry`) VALUES
...
DROP TABLE IF EXISTS `sns_picture`;
CREATE TABLE IF NOT EXISTS `sns_picture` (
...
DROP TABLE IF EXISTS `sns_rank`;
CREATE TABLE IF NOT EXISTS `sns_rank` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `sns_rank_user`;
CREATE TABLE IF NOT EXISTS `sns_rank_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sns_report` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sns_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `sns_role` (`id`, `group_id`, `name`, `title`, `description`, `user_groups`, `invite`, `audit`, `sort`, `status`, `create_time`, `update_time`) VALUES
(1, 0, 'default', '普通用户', '普通用户', '1', 0, 0, 0, 1, 1432791711, 1432791711);

DROP TABLE IF EXISTS `sns_role_config`;
CREATE TABLE IF NOT EXISTS `sns_role_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sns_role_group`;
CREATE TABLE IF NOT EXISTS `sns_role_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `sns_seo_rule`;
CREATE TABLE IF NOT EXISTS `sns_seo_rule` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` text NOT NULL,
...
--
-- 转存表中的数据 `sns_seo_rule`
--

INSERT INTO `sns_seo_rule` (`id`, `title`, `app`, `controller`, `action`, `status`, `seo_keywords`, `seo_description`, `seo_title`, `sort`, `summary`) VALUES
(1000, '整站标题', '', '', '', 1, '', '', '', 7, '-'),
...
DROP TABLE IF EXISTS `sns_sso_app`;
CREATE TABLE IF NOT EXISTS `sns_sso_app` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(50) NOT NULL,
...
DROP TABLE IF EXISTS `sns_super_links`;
CREATE TABLE IF NOT EXISTS `sns_super_links` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
DROP TABLE IF EXISTS `sns_support`;
CREATE TABLE IF NOT EXISTS `sns_support` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `sns_sync_login`;
CREATE TABLE IF NOT EXISTS `sns_sync_login` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sns_talk`;
CREATE TABLE IF NOT EXISTS `sns_talk` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `create_time` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sns_talk_message`;
CREATE TABLE IF NOT EXISTS `sns_talk_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `sns_talk_message_push`;
CREATE TABLE IF NOT EXISTS `sns_talk_message_push` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sns_talk_push`;
CREATE TABLE IF NOT EXISTS `sns_talk_push` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `sns_ucenter_admin`;
CREATE TABLE IF NOT EXISTS `sns_ucenter_admin` (
...
DROP TABLE IF EXISTS `sns_ucenter_member`;
CREATE TABLE IF NOT EXISTS `sns_ucenter_member` (
...
DROP TABLE IF EXISTS `sns_ucenter_score_type`;
CREATE TABLE IF NOT EXISTS `sns_ucenter_score_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(50) NOT NULL,
  `status` tinyint(4) NOT NULL,
...
INSERT INTO `sns_ucenter_score_type` (`id`, `title`, `status`, `unit`) VALUES
(1, '积分', 1, '分'),
(2, '威望', 1, '点'),
(3, '贡献', 1, '元'),
(4, '余额', 1, '点');

DROP TABLE IF EXISTS `sns_ucenter_setting`;
CREATE TABLE IF NOT EXISTS `sns_ucenter_setting` (
...
CREATE TABLE IF NOT EXISTS `sns_url` (
...
DROP TABLE IF EXISTS `sns_user_config`;
CREATE TABLE IF NOT EXISTS `sns_user_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sns_user_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `role_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sns_user_tag`;
CREATE TABLE IF NOT EXISTS `sns_user_tag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(25) NOT NULL,
  `status` tinyint(4) NOT NULL,
  `pid` int(11) NOT NULL,
...
INSERT INTO `sns_user_tag` (`id`, `title`, `status`, `pid`, `sort`) VALUES
(1, '默认', 1, 0, 0),
(2, '开发者', 1, 1, 0),
(3, '站长', 1, 1, 0);

DROP TABLE IF EXISTS `sns_user_tag_link`;
CREATE TABLE IF NOT EXISTS `sns_user_tag_link` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sns_user_token`;
CREATE TABLE IF NOT EXISTS `sns_user_token` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sns_verify`;
CREATE TABLE IF NOT EXISTS `sns_verify` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sns_version` (
...
DROP TABLE IF EXISTS `sns_weibo`;
CREATE TABLE IF NOT EXISTS `sns_weibo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `content` text NOT NULL,
  `create_time` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sns_weibo_comment`;
CREATE TABLE IF NOT EXISTS `sns_weibo_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sns_weibo_top`;
CREATE TABLE IF NOT EXISTS `sns_weibo_top` (
  `weibo_id` int(11) NOT NULL DEFAULT '0',
  `create_time` int(11) NOT NULL,
  PRIMARY KEY (`weibo_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='置顶微博表';

DROP TABLE IF EXISTS `sns_weibo_topic`;
CREATE TABLE IF NOT EXISTS `sns_weibo_topic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `sns_score_log`;
CREATE TABLE IF NOT EXISTS `sns_score_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `ip` bigint(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sns_ucenter_user_link` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sns_topic_link` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `sns_adv_pos`;
CREATE TABLE `sns_adv_pos` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(50) NOT NULL,
...
INSERT INTO `sns_adv_pos` VALUES ('1', 'right_below_all', '右侧底部广告', 'Weibo/Index/index', '1', '1', '0', '280px', '100px', '', '', 'all');
INSERT INTO `sns_adv_pos` VALUES ('2', 'below_checkrank', '签到下方广告', 'Weibo/Index/index', '1', '1', '0', '280px', '100px', '0 0 10px 0', '', 'all');
INSERT INTO `sns_adv_pos` VALUES ('3', 'filter_right', '过滤右方', 'Weibo/Index/index', '3', '1', '0', '300px', '30px', '', '', 'all');
INSERT INTO `sns_adv_pos` VALUES ('10', 'below_post_content', '帖子主题下方广告1', 'Forum/Index/index', '1', '1', '0', '680px', '100px', '', '', 'all');
INSERT INTO `sns_adv_pos` VALUES ('11', 'below_post_content', '论坛帖子主题下方广告', 'Forum/Index/detail', '1', '1', '', '680px', '100px', '', '', 'all');
INSERT INTO `sns_adv_pos` VALUES ('4', 'below_self_info', '个人资料下方', 'Weibo/Index/index', '1', '1', '', '280px', '100px', '0 0 10px 0', '', 'all');
INSERT INTO `sns_adv_pos` VALUES ('5', 'index_top', '资讯首页顶部广告', 'News/Index/index', '2', '1', '', '738px', '240px', '', '', 'all');
INSERT INTO `sns_adv_pos` VALUES ('6', 'index_bottom_top', '资讯首页右侧最底部广告', 'News/Index/index', '1', '1', '', '360px', '120px', '10px 0 0 0', '', 'all');
INSERT INTO `sns_adv_pos` VALUES ('9', 'slider', '首页轮播图', 'Home/Index/index', '2', '1', '{\"style\":1}', '1120px', '300px', '0 0 15px 0', '', 'all');
INSERT INTO `sns_adv_pos` VALUES ('7', 'index_right_top', '资讯首页右侧最顶部广告', 'News/Index/index', '1', '1', '[]', '360px', '120px', '0 0 10px 0', '', 'all');
INSERT INTO `sns_adv_pos` VALUES ('8', 'below_article_content', '资讯文章内容下方广告', 'News/Index/detail', '1', '1', '', '690px', '100px', '', '', 'all');

DROP TABLE IF EXISTS `sns_adv`;
CREATE TABLE `sns_adv` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
